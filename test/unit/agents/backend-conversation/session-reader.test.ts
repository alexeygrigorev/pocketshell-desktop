/**
 * Unit tests for SessionReader (extension backend port).
 *
 * These mirror test/unit/agents/conversation/session-reader.test.ts but
 * exercise the ported sources under
 * extensions/pocketshell/src/backend/agents/conversation/ and the extension
 * backend's SshConnection type.
 *
...
import { SessionReader } from '../../../../extensions/pocketshell/src/backend/agents/conversation/session-reader';
import type { ExecResult } from '../../../../extensions/pocketshell/src/backend/ssh/connection/ssh-client';
