/**
 * Unit tests for Codex session log parser (extension backend port).
 *
 * These mirror test/unit/agents/conversation/codex-parser.test.ts but
 * exercise the ported sources under
 * extensions/pocketshell/src/backend/agents/conversation/.
 */

import { describe, it, expect, beforeEach } from 'vitest';
import { parseCodexSession, resetIdCounter } from '../../../../extensions/pocketshell/src/backend/agents/conversation/parsers/codex-parser';
