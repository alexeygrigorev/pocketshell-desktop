/**
 * Unit tests for OpenCode session log parser (extension backend port).
 *
 * These mirror test/unit/agents/conversation/opencode-parser.test.ts but
 * exercise the ported sources under
 * extensions/pocketshell/src/backend/agents/conversation/.
 */

import { describe, it, expect, beforeEach } from 'vitest';
import { parseOpenCodeSession, resetIdCounter } from '../../../../extensions/pocketshell/src/backend/agents/conversation/parsers/opencode-parser';
