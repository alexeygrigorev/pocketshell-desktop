...
import type { SessionInfo } from './conversation/types';
...
const AGENT_COMMANDS: Record<Exclude<AgentType, AgentType.Unknown>, string[]> = {
...
export function cwdFromSessionPath(path: string, agentType: AgentType): string | undefined {
  if (agentType !== AgentType.Claude && agentType !== AgentType.Codex && agentType !== AgentType.OpenCode) {
    return undefined;
  }
